...
const PLACEHOLDER_UPI_LINK =
  "upi://pay?pa=sample@upi&pn=Sample%20Bank&tn=Verify%20Account&am=1.00";
...
export default function Rpd() {
  ...
  const getUPIMasterDetails = async () => {
    ...
    try {
      ...
      if (
        ...
        if (upiList.length > 0)
          requestIDRef.current = upiList[0].requestId || "";
  ...
  return (
    <>
      <section
        aria-label="Verify Bank Account via UPI QR Code"
            ...
            <div className="col-lg-10 col-md-10 col-12 m-auto">
              <form aria-label="UPI QR Verification Form" method="post">
                <div className="d-flex align-items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="sub_title">
                      Scan the below QR code using any UPI app to verify your
                ...
                <div className="qr_css">
                  <div
                    role="img"
                    aria-label="UPI QR code to verify your bank account"
                  >
                    <div
                      style={{
                        width: 300,
                  ...
                  <p>
                    {displayMinutes}:{padTwo(displaySeconds)}
                  </p>
                  {!upiPayLink && (
                    <p style={{ marginTop: 12, color: "#555", fontSize: 13 }}>
                      Sample UPI QR code shown for layout completeness. Replace
                      with live UPI QR code once dynamic data is available.
                    </p>
                  )}
                </div>
