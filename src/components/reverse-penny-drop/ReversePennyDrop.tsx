                ...
                <form aria-label="Bank Account Confirmation" method="post">
                  <div className="div">
                    ...
                    <div className="text-center">
                      <img className="m-auto" src={publicPath("/assets/images/diy/successful-tick.png")} alt="Bank account verified successfully" />
                    </div>
          ...
          <div className="container">
            <div className="row">
              <form aria-label="Bank Verification Failed" method="post">
                <div className="text-center">
                  <img className="m-auto" src={publicPath("/assets/images/diy/unsuccessful-tick.png")} alt="Verification unsuccessful" />
                </div>
                <div className="pan_confirmation">
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="img_preview text-center">
                  <img src={publicPath("/assets/images/diy/invalid-details.png")} alt="Warning: account name mismatch" />
                </div>
                <div className="text-center">
