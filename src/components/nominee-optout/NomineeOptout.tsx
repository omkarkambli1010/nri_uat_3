...
export default function NomineeOptout() {
  ...
  const confirmOptOut = async () => {
    if (!agreed) {
      toast.warning("Please check the checkbox to confirm opt-out.", {
    ...
    try {
      ...
      if (response?.status === true) {
        toast.success("Nominee opt-out confirmed.", {
          position: "bottom-center",
          autoClose: 2000,
        });
        setTimeout(() => {
        ...
        toast.error(response?.message || "Error confirming opt-out.", {
          position: "bottom-center",
          autoClose: 3000,
        });
        hideSpinner();
  ...
  return (
    <section
      aria-label="Nominee Opt-Out Confirmation"
          ...
          <div className="col-lg-10 col-12 m-auto">
            ...
            <div className="mobile_section">
              <div className="review_section mb-4">
                <p style={{ fontSize: 14 }}>
                  By opting out, you confirm that you do not wish to nominate
                  any person for your Demat account at this time. You may add a
                  nominee later by visiting your account settings.
                </p>
              </div>
              ...
              <div className="form-check mb-4">
                ...
                <label
                  ...
                  htmlFor="confirmOptOut"
                  style={{ fontSize: 14 }}
                >
                  I confirm that I do not wish to add a nominee to my Demat
                  account.
                </label>
              </div>
            </div>
